namespace Ampl.Web.Mvc
{
    ...
    public class EditorTemplateConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets the value whether to use strong-typed HTML helpers in DisplayForModel() and EditorForModel().
        /// </summary>
        /// <remarks>
        /// If this property is set to <see langword="true"/>, the <see cref="OverrideContainerProperties"/> has no effect
        /// when rendering complex types.
        /// </remarks>
        public bool UseStrongTypedHtmlHelpers { get; set; } = (DefaultConfiguration?.UseStrongTypedHtmlHelpers ?? true);
